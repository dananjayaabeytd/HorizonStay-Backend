...
class BookingControllerTest {
    ...
    void testMakeBooking_Success()
    {
        ...
        // Define behavior of hotelContractService.calculatePayableAmount
    ...
    @Test
    void testMakeBooking_NullRequestBody()
    {
    ...
    @Test
    void testMakeBooking_Exception()
    {
        // Create a valid CalculationDTO object
        CalculationDTO bookingRequest = createCalculationDTO();

        // Define behavior of hotelContractService.calculatePayableAmount to throw a runtime exception
